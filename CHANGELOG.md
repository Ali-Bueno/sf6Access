...
- Training character-specific (unique) settings list now reads each row as you navigate it (character, setting name and value), and the value when you change it.
